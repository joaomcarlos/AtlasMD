...
| `base-url`            | `/`                       | Base URL path (for GitLab Pages subpaths); `CI_PAGES_URL` overrides this at deploy time |
...
| `CI_PAGES_URL` | —       | GitLab Pages URL; set automatically by GitLab CI; overrides `base-url` |
